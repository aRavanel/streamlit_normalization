...
# https://github.com/xavialex/Streamlit-TF-Real-Time-Object-Detection/blob/master/video_utils.py
...
class VideoStream:
    ...
    def __init__(self, src, name="VideoStream", real_time=True):
        ...
        self.stream = cv2.VideoCapture(0, cv2.CAP_DSHOW) # AR
        self.stream.set(cv2.CAP_PROP_FPS, 5) # addition AR
